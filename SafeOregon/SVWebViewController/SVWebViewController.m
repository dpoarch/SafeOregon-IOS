...
- (void)viewDidLoad {
	...
	if(!deviceIsTablet) {
		...
		if(self.navigationController == nil) {
			...
			titleLeftOffset = [[appDelegate getValueForLabelWithId:@"BTN_DONE"] sizeWithFont:[UIFont boldSystemFontOfSize:12]].width+33;
		}
...
- (void)showActions {
	...
	[actionSheet addButtonWithTitle:NSLocalizedString([appDelegate getValueForLabelWithId:@"BTN_CANCEL"],@"SVWebViewController")];
